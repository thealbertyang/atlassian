...
export const SETTINGS_REGISTRY: Record<SettingKey, SettingsRegistryItem> = {
  [SETTINGS_KEYS.BASE_URL]: {
    ...
    envKeys: ["ATLASSIAN_BASE_URL", "JIRA_URL"],
  },
  [SETTINGS_KEYS.JIRA_URL]: {
    ...
    type: "string",
    defaultValue: "",
    description: "Legacy Jira URL setting (prefer atlassian.baseUrl).",
    envKeys: ["JIRA_URL", "ATLASSIAN_BASE_URL"],
  },
  [SETTINGS_KEYS.EMAIL]: {
    ...
    envKeys: ["ATLASSIAN_EMAIL", "JIRA_USER_EMAIL"],
  },
  [SETTINGS_KEYS.API_TOKEN]: {
    ...
    sensitive: true,
    envKeys: ["ATLASSIAN_API_TOKEN", "JIRA_API_TOKEN"],
  },
  [SETTINGS_KEYS.JQL]: {
  ...
  [SETTINGS_KEYS.WEBVIEW_PATH]: {
    ...
    envKeys: ["ATLASSIAN_WEBVIEW_PATH"],
  },
  [SETTINGS_KEYS.WEBVIEW_SERVER_URL]: {
    ...
    envKeys: ["ATLASSIAN_WEBVIEW_SERVER_URL"],
  },
};
